...
export default function Navegador() {
    return(
        ...
        <nav className="flex justify-center items-center text-xl p-5  ">
            ...
            <li><a className="no-underline text-[#444444] font-bold inline-block px-5 py-2.5 transition-all duration-200
                border-b-transparent hover:border-b-10 hover:border-[#2000fc]" href="/funcionalidades"> Funcionalidades </a></li>

            <li><a className="no-underline text-[#444444] font-bold inline-block px-5 py-2.5 transition-all duration-200
                border-b-transparent hover:border-b-10 hover:border-[#2000fc]"href="/prototipo"> Protótipo </a></li>
